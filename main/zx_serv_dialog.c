...
//    ESP_LOGI(TAG, "FILEMENU : num_entries %d offs %d ", num_entries, offset);
 ...
 //  return true;
    ...
    zxfimg_cpzx_video (2, (const uint8_t *) "\x00\x00\x00\x01\x01\x01\x00\x00\x02\x03\x03\x02\x00\x01\x00\x02\x02\x00\x02\x03\x02\x01\x02\x00\x02\x03\x01\x1e\x1c\x1e\x1e", 31);
